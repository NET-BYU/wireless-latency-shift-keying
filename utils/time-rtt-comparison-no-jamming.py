...
ax.plot( rtt_values[4000:8000], color="gray", linewidth=0.5, label='Node 1')
ax2.plot( rtt_values_2[4000:8000], color="blue", linewidth=0.75, label='Node 2')
...
ax2.set_ylabel('Latency (Seconds)',fontsize=16)
ax2.set_ylim(0,0.1)
